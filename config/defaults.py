...
_C.ALGORITHM.ABLATION.DCSSL=CN()
_C.ALGORITHM.ABLATION.DCSSL.SS=False
_C.ALGORITHM.ABLATION.DCSSL.SPS_HP=False
_C.ALGORITHM.ABLATION.DCSSL.SPS_HN=False
_C.ALGORITHM.ABLATION.DCSSL.CT=False
...
_C.ALGORITHM.OOD_DETECTOR.ENABLE=False
...
_C.ALGORITHM.OOD_DETECTOR.K=50  # top-k
_C.ALGORITHM.OOD_DETECTOR.THRESH_PERCENT=1.0
...
# CoSSL
_C.ALGORITHM.CoSSL = CN()
_C.ALGORITHM.CoSSL.WARM_EPOCH_TFE = 10   
_C.ALGORITHM.CoSSL.LR_TFE = 0.03 
_C.ALGORITHM.CoSSL.EMA_DECAY_TFE = 0.999
_C.ALGORITHM.CoSSL.WD_TFE =  5e-4
_C.ALGORITHM.CoSSL.MAX_LAM=0.8
...
_C.DATASET.DU.ID.DISTRIBUTION = 'Consistent' # Consistent with DL ; Random long-tailed
