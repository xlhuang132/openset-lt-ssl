...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
                 ...
                 fc2_enable=False,fc2_out_dim=None,
                 norm_layer=None):
        ...
        if self.fc2_enable:
            self.fc2 = nn.Linear(512 * block.expansion, fc2_out_dim) 
...
def resnet50(cfg):
    ...
    model = ResNet(Bottleneck, [3, 4, 6, 3],num_classes=num_classes,fc2_enable=fc2_enable,fc2_out_dim=fc2_out_dim )
    return model
