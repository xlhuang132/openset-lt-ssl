...
class MOOD2Trainer(BaseTrainer):
    def __init__(self, cfg):  
        ...
        self.projector=Projector(model_name='Resnet34').cuda()
    ...
    def train_mood_step(self):
        ...
        # modify hxl 
        # 2
        l_feature=self.projector(l_encoding)
        # === origin ====
        ...
        if (not self.ablation_enable  or self.ablation_enable and self.pap_loss_enable ) and self.iter>self.warmup_iter:
            ...
            ul_feature=self.projector(ul_feature)
            ...
            # ===============  
            ood_feature= self.projector(ood_encoding)
